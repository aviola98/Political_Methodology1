...
tabela_numero <- tibble(Ano=c(2002,2006,2010,2014,2018),
                         Incumbente_BR= c(voto_incbr2002,
                                            voto_incbr2006,
                                            voto_incbr2010,
                                            voto_incbr2014,
                                            voto_incbr2018),
                         Incumbente_EXT=c(voto_incex2002,
                                          voto_incex2006,
                                          voto_incex2010,
                                          voto_incex2014,
                                          voto_incex2018),
                        Oposicao_BR=c(voto_opbr2002,
                                      voto_opbr2006,
                                      voto_opbr2010,
                                      voto_opbr2014,
                                      voto_opbr2018),
                        Oposicao_EXT=c(voto_opex2002,
                                       voto_opex2006,
                                       voto_opex2010,
                                       voto_opex2014,
                                       voto_opex2018))
...
tabela_numero %>%
  ggplot()+
  geom_histogram(aes(x=Incumbente_BR))
```
...
tabela_1 %>%
  ggplot()+
  geom_histogram(aes(x=PCT_VOTO_INCBR))
```
