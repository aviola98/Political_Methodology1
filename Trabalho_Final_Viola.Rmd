...
hist_op_br2002 <-
eleicao_2002_br %>%
  filter(NUM_VOTAVEL==13) %>%
  group_by(NUM_VOTAVEL,QTDE_VOTOS) %>%
  ggplot()+
...
eleicao_2018_BR %>%
  ...
  group_by(NR_VOTAVEL,QT_VOTOS) %>%
  ggplot()+
  geom_histogram(aes(x=QT_VOTOS),
                 colour="black",
                 fill="orange")
...
ggarrange(hist_inc_br2002,hist_op_br2002,
          hist_inc_br2006,hist_op_br2006,
          hist_inc_br2010,hist_op_br2010,
          hist_inc_br2014,hist_op_br2014,
          hist_inc_br2018,hist_op_br2018,
          labels = c(2002,2002,
                     2006,2006
                     ,2010,2010,
                     2014,2014,
...
ggarrange(hist_inc_ext2002,hist_op_ext2002,
          hist_inc_ext2006,hist_op_ext2006,
          hist_inc_ext2010,hist_op_ext2010,
          hist_inc_ext2014,hist_op_ext2014,
          hist_inc_ext2018,hist_op_ext2018,
          labels = c(2002,2002,
                     2006,2006
                     ,2010,2010,
                     2014,2014,
