...
52772592 + 33356997 + 1727011 + 3771358 + 258 
...
58295042 + 37543178 + 1351448 + 4808553 
...
55691399 + 43638458 + 2449553 + 4685801 + 272
...
54470059 + 50937034 + 1918660 + 5216253
...
46987176 + 57666176 +  2479352 + 8599581
...
tabela_2 <-
tabela_1 %>%
  summarise(media_votos_incbr=mean(PCT_VOTO_INCBR),
            media_votos_incext=mean(PCT_VOTO_INCEXT),
...
tabela_2# %>%
  kable(caption = "Estatísticas descritivas",
        col.names = c("Média de votos no Incumbente (Brasil)",
                      "Média de votos no Incumbente (Exterior)",
                      "Média de votos na oposição (Brasil)",
                      "Média de votos na oposição (Exterior)",
                      "Média de votos nulo/branco (Brasil)",
                      "Média de votos nulo/branco (Exterior)"))
```
