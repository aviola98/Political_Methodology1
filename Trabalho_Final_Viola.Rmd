...
Mas o que se tem a dizer sobre o voto no exterior ? Há também uma diferença de padrão de voto entre os brasileiros no exterior e os que residem no país? Na literatura brasileira este aspecto é pouco explorado, embora na academia está discussão está bem documentada  (Fidrmuc & Doyle, 2004; Arkilic, 2021; Rosca,2019; Turcu & Urbatsch, 2021), indicando que o voto imigrante em seu país de origem difere do voto de seus compatriotas, tendendo mais à direita, mas, ao mesmo tempo, sendo afetado de alguma forma pelo modelo político-econômico do país para o qual emigram, causando, desta forma, uma diferença interna do voto imigrante. 

Assim, nesse trabalho procuro explorar a relação entre residir no exterior (X) e votar na direita (Y). 
...
eleicao_2018_pct_por_reg_pais %>%
  ...
  ggplot() +
   geom_col(aes(x=PAIS,
    ...
    coord_flip()+
  scale_fill_manual(values = c("HADDAD"="Red","BOLSONARO"="Blue")) +
  ggtitle("Voto brasileiro na Europa (2018)")+
  xlab("Candidato")+
  ylab("Votos") +
  theme_minimal()
...
voto_br_asia2018 <- 
  ...
  ggplot() +
   geom_col(aes(x=PAIS,
    ...
    coord_flip()+
  scale_fill_manual(values = c("HADDAD"="Red","BOLSONARO"="Blue")) +
  ggtitle("Voto brasileiro na Ásia (2018)")+
  xlab("Candidato")+
  ylab("Votos") +
  theme_minimal()
...
voto_br_america2018 <-
  ...
  ggplot() +
   geom_col(aes(x=PAIS,
    ...
    coord_flip()+
  scale_fill_manual(values = c("HADDAD"="Red","BOLSONARO"="Blue")) +
  ggtitle("Voto brasileiro na América (2018)")+
  xlab("Candidato")+
  ylab("Votos") +
  theme_minimal()
...
voto_br_africa2018 <-
  ...
  ggplot() +
   geom_col(aes(x=PAIS,
    ...
    coord_flip()+
  scale_fill_manual(values = c("HADDAD"="Red","BOLSONARO"="Blue")) +
  ggtitle("Voto brasileiro na África (2018)")+
  xlab("Candidato")+
  ylab("Votos") +
  theme_minimal()
...
voto_br_oceania2018 <-
  ...
  ggplot() +
   geom_col(aes(x=PAIS,
    ...
    coord_flip()+
  scale_fill_manual(values = c("HADDAD"="Red","BOLSONARO"="Blue")) +
  ggtitle("Voto brasileiro na Oceania (2018)")+
  xlab("Candidato")+
  ylab("Votos") +
  theme_minimal()
