...
Com a finalidade de testar a relação foi realizado um Teste de Hipótesis de tipo $\chi²$, uma vez que 
$$
H_0: \mu{\text{(votos na oposição|voto no exterior)}} = \mu{\text{(votos na oposição|votos no Brasil)}}
$$

$$
H_1: \mu{\text{(votos na oposição|voto no exterior)}} > \mu{\text{(votos na oposição|votos no Brasil)}}
$$
